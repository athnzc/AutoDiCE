...
namespace ncnn {
class AbsVal_final_cuda:  virtual public AbsVal, virtual public AbsVal_cuda
{
public:
...
DEFINE_LAYER_CREATOR(AbsVal_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/batchnorm_cuda.h"
namespace ncnn {
class BatchNorm_final_cuda:  virtual public BatchNorm, virtual public BatchNorm_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = BatchNorm_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = BatchNorm_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(BatchNorm_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/bias_cuda.h"
namespace ncnn {
class Bias_final_cuda:  virtual public Bias, virtual public Bias_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Bias_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Bias_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Bias_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/bnll_cuda.h"
namespace ncnn {
class BNLL_final_cuda:  virtual public BNLL, virtual public BNLL_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = BNLL_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = BNLL_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(BNLL_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/concat_cuda.h"
namespace ncnn {
class Concat_final_cuda:  virtual public Concat, virtual public Concat_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Concat_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Concat_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Concat_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/convolution_cuda.h"
namespace ncnn {
class Convolution_final_cuda:  virtual public Convolution, virtual public Convolution_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Convolution_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Convolution_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Convolution_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/crop_cuda.h"
namespace ncnn {
class Crop_final_cuda:  virtual public Crop, virtual public Crop_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Crop_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Crop_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Crop_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/flatten_cuda.h"
namespace ncnn {
class Flatten_final_cuda:  virtual public Flatten, virtual public Flatten_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Flatten_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Flatten_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Flatten_final_cuda)
} // namespace ncnn
...
namespace ncnn {
class InnerProduct_final_cuda:  virtual public InnerProduct, virtual public InnerProduct_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
...
DEFINE_LAYER_CREATOR(InnerProduct_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/input_cuda.h"
namespace ncnn {
class Input_final_cuda:  virtual public Input, virtual public Input_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Input_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Input_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Input_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/pooling_cuda.h"
namespace ncnn {
class Pooling_final_cuda:  virtual public Pooling, virtual public Pooling_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Pooling_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Pooling_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Pooling_final_cuda)
} // namespace ncnn
...
namespace ncnn {
class ReLU_final_cuda:  virtual public ReLU, virtual public ReLU_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = ReLU_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = ReLU_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(ReLU_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/reshape_cuda.h"
namespace ncnn {
class Reshape_final_cuda:  virtual public Reshape, virtual public Reshape_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Reshape_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Reshape_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Reshape_final_cuda)
} // namespace ncnn
...
namespace ncnn {
class Softmax_final_cuda:  virtual public Softmax, virtual public Softmax_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Softmax_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Softmax_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Softmax_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/split_cuda.h"
namespace ncnn {
class Split_final_cuda:  virtual public Split, virtual public Split_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Split_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Split_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Split_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/binaryop_cuda.h"
namespace ncnn {
class BinaryOp_final_cuda:  virtual public BinaryOp, virtual public BinaryOp_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = BinaryOp_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = BinaryOp_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(BinaryOp_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/convolutiondepthwise_cuda.h"
namespace ncnn {
class ConvolutionDepthWise_final_cuda:  virtual public ConvolutionDepthWise, virtual public ConvolutionDepthWise_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = ConvolutionDepthWise_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = ConvolutionDepthWise_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(ConvolutionDepthWise_final_cuda)
} // namespace ncnn
...
namespace ncnn {
class Padding_final_cuda:  virtual public Padding, virtual public Padding_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
...
DEFINE_LAYER_CREATOR(Padding_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/quantize_cuda.h"
namespace ncnn {
class Quantize_final_cuda:  virtual public Quantize, virtual public Quantize_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Quantize_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Quantize_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Quantize_final_cuda)
} // namespace ncnn
...
#include "layer/cuda/packing_cuda.h"
namespace ncnn {
class Packing_final_cuda:  virtual public Packing, virtual public Packing_cuda
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Packing_cuda::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Packing_cuda::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Packing_final_cuda)
} // namespace ncnn
...
namespace ncnn {
class Receiver_final : virtual public Receiver
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Receiver::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Receiver::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Receiver_final)
} // namespace ncnn

#include "layer/sender.h"
namespace ncnn {
class Sender_final : virtual public Sender
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Sender::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Sender::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(Sender_final)
} // namespace ncnn
...
namespace ncnn {
class MyLayer_final : virtual public MyLayer
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = MyLayer::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = MyLayer::destroy_pipeline(opt); if (ret) return ret; }
        return 0;
    }
};
DEFINE_LAYER_CREATOR(MyLayer_final)
} // namespace ncnn
